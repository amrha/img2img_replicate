...
class Predictor(BasePredictor):
    ...
    def setup(self):
        ...
        self.pipe = StableDiffusionImg2ImgPipeline.from_pretrained(self.pipeline_model,safety_checker = None,
    ...
    def predict(self,
                image: Path = Input(description="Input image",default="://replicate.delivery/pbxt/JGOy8ujBvolu3MsUoPw7i4oyTdb2BeuM2qPcF7UMH4cqPdhj/sketch-mountains-input.jpg"),
                prompt: str = Input(description="Guidance prompt for the image transformation",default="A painting in the style of van gogh."),
                strength: float = 0.75,
